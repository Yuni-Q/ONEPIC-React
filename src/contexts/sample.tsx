...
const Context = React.createContext('light'); // Context 를 만듭니다.
...
class SampleProvider extends React.Component<{}, {isAuthenticated: boolean}> {

  public actions: {setValue: (isAuthenticated: boolean) => void} = {
  ...
  public render() {
    ...
    return (
      <Provider value={"string"}>//{isAuthenticated}>
        {this.props.children}
      </Provider>
    )
  }
